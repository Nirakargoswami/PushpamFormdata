...
const TermsOfService = () => {
  ...
  return (
    <main className="MuiBox-root css-1ezwkbm" style={containerStyle}>
      ...
      <div style={{ marginTop: "20px" }}>
        ...
        <div>
          ...
          <p>
            ...
            regulations, privacy policy and Terms of Use for access or usage of domain name srimahalaxmi.
            org.in ('Website'), including the related mobile site and mobile application (hereinafter referred to
            as 'Platform').
          </p>
          <p>
            The Platform is owned by Nirakar giri, a company incorporated under the Companies Act, 1956
            with its registered office at Abdasan idar district sabarkndha Himatnagar India (hereinafter
          ...
          <strong>The use of Platform and/or availing of our Services is subject to the following Terms of Use:</strong>, it is services. If you have any
          ...
          <p>
            ...
            All disputes arising out of or in connection with these Terms shall be subject to the exclusive
            jurisdiction of the courts in Himatnagar and Gujarat.
